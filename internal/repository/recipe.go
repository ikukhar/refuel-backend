...
func (r *RecipeRepository) SeedRecipes() error {
	...
	recipes := []model.Recipe{
		// ── ЗАВТРАК ──
		{Title: "Овсяная каша с ягодами", MealType: model.MealBreakfast, Calories: 320, ProteinG: 12, FatG: 8, CarbsG: 52, Description: "Геркулес на молоке с сезонными ягодами и мёдом",
		...
		{Title: "Сырники со сметаной", MealType: model.MealBreakfast, Calories: 380, ProteinG: 24, FatG: 16, CarbsG: 34, Description: "Нежные творожные сырники",
		...
		{Title: "Яичница с авокадо", MealType: model.MealBreakfast, Calories: 350, ProteinG: 20, FatG: 24, CarbsG: 10, Description: "Глазунья на тосте с авокадо",
		...
		{Title: "Греческий йогурт с гранолой", MealType: model.MealBreakfast, Calories: 290, ProteinG: 18, FatG: 10, CarbsG: 36, Description: "Густой йогурт с хрустящей гранолой и бананом",
		...
		{Title: "Блинчики с творогом", MealType: model.MealBreakfast, Calories: 410, ProteinG: 22, FatG: 14, CarbsG: 48, Description: "Тонкие блины с творожной начинкой",
		...
		{Title: "Каша рисовая с тыквой", MealType: model.MealBreakfast, Calories: 280, ProteinG: 8, FatG: 6, CarbsG: 50, Description: "Сладкая рисовая каша с запечённой тыквой",
		...
		{Title: "Тост с арахисовой пастой", MealType: model.MealBreakfast, Calories: 340, ProteinG: 14, FatG: 18, CarbsG: 32, Description: "Хрустящий тост с пастой и бананом",
		...
		{Title: "Омлет с овощами", MealType: model.MealBreakfast, Calories: 310, ProteinG: 22, FatG: 18, CarbsG: 12, Description: "Пышный омлет с помидорами и шпинатом",
		...
		{Title: "Пудинг чиа с манго", MealType: model.MealBreakfast, Calories: 270, ProteinG: 10, FatG: 12, CarbsG: 32, Description: "Холодный завтрак из семян чиа на кокосовом молоке",
		...
		{Title: "Драники со сметаной", MealType: model.MealBreakfast, Calories: 360, ProteinG: 10, FatG: 16, CarbsG: 44, Description: "Хрустящие картофельные оладьи",
		...
		{Title: "Запеканка творожная", MealType: model.MealBreakfast, Calories: 340, ProteinG: 26, FatG: 12, CarbsG: 32, Description: "Классическая творожная запеканка с изюмом",
		...
		{Title: "Смузи-боул с киноа", MealType: model.MealBreakfast, Calories: 310, ProteinG: 14, FatG: 9, CarbsG: 46, Description: "Густой смузи с киноа и topping'ами",
		...
		// ── ОБЕД ──
		{Title: "Куриный суп с лапшой", MealType: model.MealLunch, Calories: 280, ProteinG: 22, FatG: 8, CarbsG: 30, Description: "Наваристый куриный суп с домашней лапшой",
		...
		{Title: "Паста карбонара", MealType: model.MealLunch, Calories: 520, ProteinG: 28, FatG: 22, CarbsG: 52, Description: "Спагетти с беконом и сливочным соусом",
		...
		{Title: "Борщ с говядиной", MealType: model.MealLunch, Calories: 320, ProteinG: 20, FatG: 12, CarbsG: 34, Description: "Красный борщ с мясом и сметаной",
		...
		{Title: "Рис с курицей и овощами", MealType: model.MealLunch, Calories: 420, ProteinG: 32, FatG: 10, CarbsG: 52, Description: "Рассольник с перловой крупой",
		...
		{Title: "Стейк из лосося с пюре", MealType: model.MealLunch, Calories: 480, ProteinG: 36, FatG: 22, CarbsG: 32, Description: "Сочный лосось с нежным картофельным пюре",
		...
		{Title: "Гречка с тушёнкой", MealType: model.MealLunch, Calories: 450, ProteinG: 28, FatG: 18, CarbsG: 46, Description: "Гречневая каша с мясной тушёнкой",
		...
		{Title: "Цезарь с курицей", MealType: model.MealLunch, Calories: 380, ProteinG: 32, FatG: 18, CarbsG: 18, Description: "Классический салат Цезарь с куриной грудкой",
		...
		{Title: "Том-ям с креветками", MealType: model.MealLunch, Calories: 260, ProteinG: 18, FatG: 14, CarbsG: 16, Description: "Острый тайский суп на кокосовом молоке",
		...
		{Title: "Лазанья болоньезе", MealType: model.MealLunch, Calories: 550, ProteinG: 30, FatG: 24, CarbsG: 50, Description: "Многослойная паста с мясным соусом и бешамелью",
		...
		{Title: "Котлеты по-киевски с пюре", MealType: model.MealLunch, Calories: 510, ProteinG: 30, FatG: 26, CarbsG: 38, Description: "Куриная котлета с маслом внутри",
		...
		{Title: "Куриная грудка с киноа", MealType: model.MealLunch, Calories: 400, ProteinG: 38, FatG: 8, CarbsG: 42, Description: "Запечённая курица с киноа и овощами гриль",
		...
		{Title: "Уха рыбацкая", MealType: model.MealLunch, Calories: 190, ProteinG: 24, FatG: 4, CarbsG: 16, Description: "Ароматный суп из речной рыбы",
		...
		// ── УЖИН ──
		{Title: "Свинина с овощами в духовке", MealType: model.MealDinner, Calories: 420, ProteinG: 30, FatG: 20, CarbsG: 28, Description: "Запечённая свинина с овощами",
		...
		{Title: "Рыбное филе на пару", MealType: model.MealDinner, Calories: 220, ProteinG: 32, FatG: 8, CarbsG: 6, Description: "Нежное филе трески на пару с брокколи",
		...
		{Title: "Спагетти с морепродуктами", MealType: model.MealDinner, Calories: 380, ProteinG: 26, FatG: 12, CarbsG: 46, Description: "Паста с креветками и мидиями в сливочном соусе",
		...
		{Title: "Индейка с овощами гриль", MealType: model.MealDinner, Calories: 350, ProteinG: 34, FatG: 12, CarbsG: 24, Description: "Сочное филе индейки с гриль-овощами",
		...
		{Title: "Овощное рагу с нутом", MealType: model.MealDinner, Calories: 310, ProteinG: 14, FatG: 10, CarbsG: 42, Description: "Сытное рагу без мяса",
		...
		{Title: "Куриные крылья BBQ", MealType: model.MealDinner, Calories: 450, ProteinG: 28, FatG: 24, CarbsG: 30, Description: "Запечённые крылья в соусе барбекю",
		...
		{Title: "Салат с тунцом и яйцом", MealType: model.MealDinner, Calories: 280, ProteinG: 28, FatG: 14, CarbsG: 8, Description: "Лёгкий салат с консервированным тунцом",
		...
		{Title: "Тыквенный крем-суп", MealType: model.MealDinner, Calories: 240, ProteinG: 8, FatG: 14, CarbsG: 24, Description: "Нежный суп-пюре из запечённой тыквы",
		...
		{Title: "Стейк из говядины с рукколой", MealType: model.MealDinner, Calories: 480, ProteinG: 38, FatG: 28, CarbsG: 12, Description: "Сочный стейк Рибай с салатом из рукколы",
		...
		{Title: "Фаршированные перцы", MealType: model.MealDinner, Calories: 380, ProteinG: 24, FatG: 16, CarbsG: 32, Description: "Болгарские перцы с мясной начинкой",
		...
		{Title: "Плов узбекский", MealType: model.MealDinner, Calories: 520, ProteinG: 24, FatG: 18, CarbsG: 64, Description: "Классический узбекский плов с бараниной",
		...
		{Title: "Форель с лимоном и розмарином", MealType: model.MealDinner, Calories: 340, ProteinG: 34, FatG: 20, CarbsG: 4, Description: "Запечённая форель с травами",
		...
		// ── ПЕРЕКУС ──
		{Title: "Энергетические батончики", MealType: model.MealSnack, Calories: 200, ProteinG: 8, FatG: 10, CarbsG: 22, Description: "Домашние батончики из овсянки и орехов",
		...
		{Title: "Гренки с сыром и чесноком", MealType: model.MealSnack, Calories: 250, ProteinG: 12, FatG: 14, CarbsG: 22, Description: "Хрустящие гренки к супу или пиву",
		...
		{Title: "Фруктовый салат", MealType: model.MealSnack, Calories: 150, ProteinG: 2, FatG: 4, CarbsG: 30, Description: "Микс из сезонных фруктов",
		...
		{Title: "Бутерброд с лососем", MealType: model.MealSnack, Calories: 280, ProteinG: 16, FatG: 14, CarbsG: 22, Description: "Открытый сэндвич с лососем и сливочным сыром",
		...
		{Title: "Орехи и сухофрукты", MealType: model.MealSnack, Calories: 180, ProteinG: 6, FatG: 12, CarbsG: 16, Description: "Микс из орехов и сухофруктов на 30г",
			Ingredients: `["миндаль 10г","грецкий орех 10г","курага 10г","чернослив 10г"]`, Steps: `["Смешать всё в одной порции"]`},
		{Title: "Ролл из лаваша с курицей", MealType: model.MealSnack, Calories: 340, ProteinG: 22, FatG: 14, CarbsG: 28, Description: "Лаваш с курицей, овощами и соусом",
		...
		{Title: "Чипсы из батата", MealType: model.MealSnack, Calories: 160, ProteinG: 2, FatG: 8, CarbsG: 22, Description: "Полезные чипсы из батата в духовке",
		...
		{Title: "Сырные шарики", MealType: model.MealSnack, Calories: 230, ProteinG: 14, FatG: 16, CarbsG: 8, Description: "Закусочные шарики из сыра с чесноком и зеленью",
		...
		{Title: "Хумус с овощными палочками", MealType: model.MealSnack, Calories: 190, ProteinG: 8, FatG: 12, CarbsG: 16, Description: "Нутовый хумус с морковью и сельдереем",
		...
		{Title: "Банановые панкейки", MealType: model.MealSnack, Calories: 220, ProteinG: 8, FatG: 6, CarbsG: 36, Description: "Мини-панкейки на банановой основе",
		...
		{Title: "Творог с зеленью", MealType: model.MealSnack, Calories: 140, ProteinG: 18, FatG: 6, CarbsG: 6, Description: "Свежий творог с зеленью и огурцом",
		...
		{Title: "Авокадо с креветками", MealType: model.MealSnack, Calories: 220, ProteinG: 12, FatG: 16, CarbsG: 6, Description: "Фаршированное авокадо с салатными креветками",
